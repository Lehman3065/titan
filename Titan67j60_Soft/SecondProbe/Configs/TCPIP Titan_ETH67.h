 ...
 */
#define MY_DEFAULT_HOST_NAME			"TITAN"

#define MY_DEFAULT_MAC_BYTE1            (0x02)	// Locally administered addresses
#define MY_DEFAULT_MAC_BYTE2            (0xCA)	// "К"отёл
#define MY_DEFAULT_MAC_BYTE3            (0xD2)	// "Т"итан 
#define MY_DEFAULT_MAC_BYTE4            (0x00)	// Serial number of Titan Boiler
