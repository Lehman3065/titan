...
"		<friendlyName>LED controller</friendlyName>\r\n" \
"		<manufacturer>DonAlfredo</manufacturer>\r\n" \
"		<manufacturerURL>http://www.donalfredo.nl</manufacturerURL>\r\n" \
"		<modelName>RGBW-IPCONTROLLER</modelName>\r\n" \
"		<modelDescription>First try of an IP controller for LED drivers</modelDescription>\r\n" \
"		<modelNumber>Modelnumber5</modelNumber>\r\n" \
"		<modelURL>http://www.donalfredo.nl/IPLEDLight</modelURL>\r\n" \
"		<serialNumber>DON-12345678</serialNumber>\r\n"
...
void UPNPServer(void)
{
    ...
    case SM_LISTENING:
        ...
        if (memcmppgm2ram(AppBuffer, (ROM void*) "GET /device.xml", 15) == 0)
        {
            ...
            if (memcmppgm2ram(AppBuffer, (ROM void*) "GET /switchpower.xml", 20) == 0)
        {
