	...
	; Compiler options:
	;
	; --chip=18F67J60 -G -mdist/default/debug/ThirdProbe.debug.map \
	; -D__DEBUG=1 --debugger=none --double=24 --float=24 --emi=wordwrite \
	...
	; -odist/default/debug/ThirdProbe.debug.elf build/default/debug/main.p1 \
	; build/default/debug/timers.p1 build/default/debug/titan.p1
	;
